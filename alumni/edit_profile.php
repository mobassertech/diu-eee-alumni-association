...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE member SET Email = ?, Password = ? WHERE Member_id = ?";
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline mb-4">
                                <div class="card-header">
                                    <div class="card-title">Hello, <?php echo htmlspecialchars($memberName); ?>! Please update the information below to improve your profile.</div>
                                </div>
